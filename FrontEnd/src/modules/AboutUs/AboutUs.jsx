...
const About = () => {
  ...
  <Header/>
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <p className="text-xl leading-7 text-gray-500 mb-8">
        We are a team of passionate individuals who love creating awesome things with code.
      </p>
      <p className="text-xl leading-7 text-gray-500 mb-8">
      Electronic E-Commerce was founded in 2010 by two tech enthusiasts, Andres and Johnson, who recognized the potential of e-commerce in the rapidly growing electronic industry. The duo, who had extensive experience in the electronic retail sector, realized that there was a gap in the market for an online platform that offered a wide range of electronic products at competitive prices.
      They started their journey by building a user-friendly website that offered a seamless shopping experience for customers. The website quickly gained popularity among electronic enthusiasts, and the founders expanded their product range to include laptops, mobile phones, cameras, smartwatches, headphones, and other electronic accessories from well-known brands.
      With their focus on customer satisfaction and a commitment to offering high-quality products, Electronic E-Commerce continued to grow and flourish. Over the years, the company has invested heavily in its technology, infrastructure, and customer support, ensuring that its customers receive the best possible service.
      Today, Electronic E-Commerce is a well-established e-commerce platform that caters to customers around the world. Its success is a testament to the founders' vision, dedication, and hard work, as well as their ability to stay ahead of the curve in the ever-changing electronic industry.
       </p>
