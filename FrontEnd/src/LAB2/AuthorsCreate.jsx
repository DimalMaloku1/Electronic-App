...
const AuthorsCreate = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const addressPayload = { name, birthyear };
  ...
  return (
    <div className="max-w-lg mx-auto pt-6 pl-1 pr-1">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2">birthyear</label>
          <input
            required
            value={birthyear}
            ...
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
          />
          {birthyear.length === 0 && validation && <span className="text-danger">Enter the birthyear</span>}
        </div>
